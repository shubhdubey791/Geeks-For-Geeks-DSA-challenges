<h2><a href="https://www.geeksforgeeks.org/problems/small-factorial0854/1?page=2&category=Mathematical&difficulty=Basic&status=unsolved&sortBy=submissions">Small Factorial</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size:18px">Calculate factorial of a given number <strong>N</strong>.</span><br>
&nbsp;</p>
